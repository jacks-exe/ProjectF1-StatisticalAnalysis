...
if ($id1 === null || $id2 === null) {
    responder_erro(400, 'Informe id1 e id2 na query string.');
}

$conexao = obter_conexao();
$comparacao = comparar_pilotos($conexao, $id1, $id2);

if ($comparacao === null) {
    responder_erro(404, 'Um ou ambos os pilotos nao foram encontrados.');
}
